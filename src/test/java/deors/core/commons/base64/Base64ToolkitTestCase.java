...
public class Base64ToolkitTestCase {
    ...
    public void testEncodeStringEncoding()
        ...
        assertEquals("4ent8/rx" + NEW_LINE, Base64Toolkit.encode("áéíóúñ", "ISO-8859-1"));

        assertEquals("b3JpZ2luYWwgc3RyaW5n" + NEW_LINE, Base64Toolkit.encode("original string", "UTF-8"));
        assertEquals("w6HDqcOtw7PDusOx" + NEW_LINE, Base64Toolkit.encode("áéíóúñ", "UTF-8"));
    }
    ...
    public void testDecodeBytesInvalid()
        ...
        assertArrayEquals(new byte[0], Base64Toolkit.decode("áéíóúñ".getBytes()));
    ...
    public void testDecodeStringInvalid()
        ...
        assertEquals("", Base64Toolkit.decode("áéíóúñ"));
    ...
    public void testDecodeStringEncoding()
        ...
        assertEquals("áéíóúñ", Base64Toolkit.decode("4ent8/rx", "ISO-8859-1"));

        assertEquals("original string", Base64Toolkit.decode("b3JpZ2luYWwgc3RyaW5n", "UTF-8"));
        assertEquals("áéíóúñ", Base64Toolkit.decode("w6HDqcOtw7PDusOx", "UTF-8"));
    }
