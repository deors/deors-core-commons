...
public final class SchedulerServlet
    ...
    private static final String CHARACTER_ENCODING =
        getConfigurationProperty("sched.characterEncoding", "UTF-8"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private static final String CONTENT_TYPE =
        getConfigurationProperty("sched.contentType", "text/html"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private static final String DATE_FORMAT =
        getConfigurationProperty("sched.dateFormat", "yyyy/MM/dd HH:mm:ss"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-header.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_HEADER =
        getConfigurationProperty("sched.templateHeader", "/deors/core/commons/schedulertemplates/scheduler-header.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-footer.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_FOOTER =
        getConfigurationProperty("sched.templateFooter", "/deors/core/commons/schedulertemplates/scheduler-footer.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-message-header.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_MESSAGE_HEADER =
        getConfigurationProperty("sched.templateMessageHeader", "/deors/core/commons/schedulertemplates/scheduler-message-header.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-message-footer.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_MESSAGE_FOOTER =
        getConfigurationProperty("sched.templateMessageFooter", "/deors/core/commons/schedulertemplates/scheduler-message-footer.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-message-item.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_MESSAGE_ITEM =
        getConfigurationProperty("sched.templateMessageItem", "/deors/core/commons/schedulertemplates/scheduler-message-item.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-error-header.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_ERROR_HEADER =
        getConfigurationProperty("sched.templateErrorHeader", "/deors/core/commons/schedulertemplates/scheduler-error-header.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-error-footer.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_ERROR_FOOTER =
        getConfigurationProperty("sched.templateErrorFooter", "/deors/core/commons/schedulertemplates/scheduler-error-footer.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-error-item.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_ERROR_ITEM =
        getConfigurationProperty("sched.templateErrorItem", "/deors/core/commons/schedulertemplates/scheduler-error-item.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-help.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_HELP =
        getConfigurationProperty("sched.templateHelp", "/deors/core/commons/schedulertemplates/scheduler-help.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-command-1.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_COMMAND_1 =
        getConfigurationProperty("sched.templateCommand1", "/deors/core/commons/schedulertemplates/scheduler-command-1.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-command-2.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_COMMAND_2 =
        getConfigurationProperty("sched.templateCommand2", "/deors/core/commons/schedulertemplates/scheduler-command-2.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-command-3.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_COMMAND_3 =
        getConfigurationProperty("sched.templateCommand3", "/deors/core/commons/schedulertemplates/scheduler-command-3.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-task-header.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_TASK_HEADER =
        getConfigurationProperty("sched.templateTaskHeader", "/deors/core/commons/schedulertemplates/scheduler-task-header.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-task-footer.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_TASK_FOOTER =
        getConfigurationProperty("sched.templateTaskFooter", "/deors/core/commons/schedulertemplates/scheduler-task-footer.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-task-item-1.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_TASK_ITEM_1 =
        getConfigurationProperty("sched.templateTaskItem1", "/deors/core/commons/schedulertemplates/scheduler-task-item-1.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-task-item-2.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_TASK_ITEM_2 =
        getConfigurationProperty("sched.templateTaskItem2", "/deors/core/commons/schedulertemplates/scheduler-task-item-2.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
     ...
     * <code>/deors/core/commons/schedulertemplates/scheduler-task-item-3.tmpl</code>.
     *
     * @see CommonsContext#getConfigurationProperty(String, String)
     */
    private static final String TEMPLATE_TASK_ITEM_3 =
        getConfigurationProperty("sched.templateTaskItem3", "/deors/core/commons/schedulertemplates/scheduler-task-item-3.tmpl"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void processCommandStart(HttpServletRequest request, List<String> messages)
        ...
        if (initialized) {
            ...
            messages.add(getMessage("SCHED_SERVLET_LOG_ALREADY_STARTED")); //$NON-NLS-1$
            ...
            messages.add(getMessage("SCHED_SERVLET_LOG_STARTED")); //$NON-NLS-1$
        }
    }
    ...
    private void processCommandStop(HttpServletRequest request, List<String> messages, List<String> errors) {
        ...
        if (taskName == null || taskName.length() == 0) {
            ...
            stopAllTasks();
            messages.add(getMessage("SCHED_SERVLET_LOG_STOPPED")); //$NON-NLS-1$

        } else {
            if (sch.existsTask(taskName)) {

                stopTask(taskName);
                messages.add(getMessage("SCHED_SERVLET_LOG_TASK_STOPPED", taskName)); //$NON-NLS-1$
            } else {
                errors.add(getMessage("SCHED_SERVLET_LOG_TASK_NOT_EXIST", taskName)); //$NON-NLS-1$
            }
        }
    }
    ...
    private void processCommandRemove(HttpServletRequest request, List<String> messages, List<String> errors) {
        ...
        if (taskName == null || taskName.length() == 0) {
            ...
            errors.add(getMessage("SCHED_SERVLET_ERR_NO_TASK_NAME")); //$NON-NLS-1$

        } else {
            if (sch.existsTask(taskName)) {

                stopAndRemoveTask(taskName);
                messages.add(getMessage("SCHED_SERVLET_LOG_TASK_REMOVED", taskName)); //$NON-NLS-1$
            } else {
                errors.add(getMessage("SCHED_SERVLET_LOG_TASK_NOT_EXIST", taskName)); //$NON-NLS-1$
            }
        }
    ...
    private void processCommandAdd(HttpServletRequest request, List<String> messages, List<String> errors) {
        ...
        if (newErrors.isEmpty()) {
            try {
                ...
                messages.add(getMessage("SCHED_SERVLET_LOG_TASK_SCHEDULED", taskName)); //$NON-NLS-1$
    ...
    private String parseTaskName(HttpServletRequest request, List<String> newErrors) {
        ...
        if (taskName == null || taskName.length() == 0) {
            ...
            newErrors.add(getMessage("SCHED_SERVLET_ERR_NO_TASK_NAME")); //$NON-NLS-1$
        }
    ...
    private String parseTaskClassName(HttpServletRequest request, List<String> newErrors) {
        ...
        if (taskClassName == null || taskClassName.length() == 0) {
            ...
            newErrors.add(getMessage("SCHED_SERVLET_ERR_NO_TASK_CLASS")); //$NON-NLS-1$
        }
    ...
    private String parseTaskDescription(HttpServletRequest request, List<String> newErrors) {
        ...
        if (taskDescription == null || taskDescription.length() == 0) {
            ...
            newErrors.add(getMessage("SCHED_SERVLET_ERR_NO_TASK_DESCRIPTION")); //$NON-NLS-1$
        }
    ...
    private Calendar parseTaskStartTime(HttpServletRequest request, List<String> newErrors) {
        ...
        if (tempStartTime == null || tempStartTime.length() == 0) {
            ...
            newErrors.add(getMessage("SCHED_SERVLET_ERR_NO_TASK_START")); //$NON-NLS-1$
    ...
    private Calendar parseTaskStopTime(HttpServletRequest request, List<String> newErrors) {
        ...
        if (tempStopTime == null || tempStopTime.length() == 0) {
            ...
            newErrors.add(getMessage("SCHED_SERVLET_ERR_NO_TASK_STOP")); //$NON-NLS-1$
    ...
    private void processCommandKill(HttpServletRequest request, List<String> messages, List<String> errors) {
        ...
        if (taskName == null || taskName.length() == 0) {
            ...
            if (sch.existsTask(taskName)) {
                ...
                killTask(taskName);
                messages.add(getMessage("SCHED_SERVLET_LOG_TASK_KILLED", taskName)); //$NON-NLS-1$
            } else {
                errors.add(getMessage("SCHED_SERVLET_LOG_TASK_NOT_EXIST", taskName)); //$NON-NLS-1$
            }
        }
    ...
    private void prepareTaskState(SchedulerTask task, Map<String, String> replacements) {
        ...
        if (task.isStarting()) {
            replacements.put(TEMPLATE_TASK_STATE,
                getMessage("SCHED_SERVLET_STATE_STARTING")); //$NON-NLS-1$
        } else if (task.isStopping()) {
            replacements.put(TEMPLATE_TASK_STATE,
                getMessage("SCHED_SERVLET_STATE_STOPPING")); //$NON-NLS-1$
        } else if (task.isExecuting()) {
            if (task.taskThread == null) {
                replacements.put(TEMPLATE_TASK_STATE,
                    getMessage("SCHED_SERVLET_STATE_THREAD_NULL")); //$NON-NLS-1$
            } else {
                replacements.put(TEMPLATE_TASK_STATE,
                    getMessage("SCHED_SERVLET_STATE_RUNNING", task.taskThread.toString())); //$NON-NLS-1$
            }
        } else {
            replacements.put(TEMPLATE_TASK_STATE,
                getMessage("SCHED_SERVLET_STATE_IDLE")); //$NON-NLS-1$
        }
    }
        ...
        if (task.isDaemonTask()) {
            if (task.isDaemonExecuted()) {
                replacements.put(TEMPLATE_TASK_INFO,
                    getMessage("SCHED_SERVLET_INFO_DAEMON_EXECUTED")); //$NON-NLS-1$
            } else {
                replacements.put(TEMPLATE_TASK_INFO,
                    getMessage("SCHED_SERVLET_INFO_DAEMON_IDLE")); //$NON-NLS-1$
            }
            ...
            replacements.put(TEMPLATE_TASK_INFO,
                getMessage("SCHED_SERVLET_INFO_NOT_AVAILABLE")); //$NON-NLS-1$
        }
    }
